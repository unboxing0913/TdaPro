...
import org.unboxing.service.Notice_ReplyService;

import lombok.AllArgsConstructor;
import lombok.extern.log4j.Log4j;

@RequestMapping("/notice/replies/")
...
public class Notice_ReplyController {
	...
	private Notice_ReplyService service;
...
// @PathVariable("") : URL 경로에 있는 값을 파라미터로 추출하려고 할때 사용 
	...
	public ResponseEntity<String> create(@RequestBody Notice_ReplyVO vo){
		
		log.info("Notice_ReplyVO : " + vo );
	...
	public ResponseEntity<List<Notice_ReplyVO>> getList(
	...
	*/
	...
	@GetMapping(value="/pages/{bno}/{page}",
			produces = {MediaType.APPLICATION_XML_VALUE , MediaType.APPLICATION_JSON_UTF8_VALUE})
	public ResponseEntity<Notice_ReplyPageDTO> getList(@PathVariable("page") int page , @PathVariable("bno") Long bno){
	...
	@GetMapping(value="/{rno}",
			produces = {MediaType.APPLICATION_XML_VALUE , MediaType.APPLICATION_JSON_UTF8_VALUE})
	public ResponseEntity<Notice_ReplyVO> get(@PathVariable("rno") Long rno){
	...
	public ResponseEntity<String> remove(@PathVariable("rno") Long rno,@RequestBody Notice_ReplyVO vo){
